...
export const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [ChainId.HARDHAT]: CurrencyAmount.fromRawAmount(USD[ChainId.HARDHAT], 100_000e6),
  [ChainId.NERVOS_TESTNET]: CurrencyAmount.fromRawAmount(USD[ChainId.NERVOS_TESTNET], 100_000e6),
}
